...
export default function StatusBar({ tab }: Props) {
  ...
  return (
    <div className="flex items-center justify-between px-4 h-7 text-[11px] bg-background border-t border-border text-muted-foreground select-none shrink-0 font-medium">
      ...
      <div className="flex items-center gap-2 max-w-[50%]">
        <span className="truncate opacity-60 hover:opacity-100 transition-opacity cursor-default">
